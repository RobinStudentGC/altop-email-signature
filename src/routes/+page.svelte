...
>
	<div class="handtekening-block" style="width: 100%; box-sizing: border-box;">
		<div
			class="handtekening-verzender-content"
			style="width: 100%; display: flex; justify-content: space-between; flex-wrap: wrap;"
		>
			<div
				class="verzender-cell"
				style="padding: 10px 20px 10px 20px; font-size: 1em; box-sizing: border-box;"
			>
			...
			>
				<img
					class="base-img"
					data-src="https://docker07.ap.altop:5194/images/Logo%20AltopT.png"
					alt="Altop Logo"
		...
		<div class="balk" style="width: 100%;">
			<img
				class="base-img"
				data-src="https://docker07.ap.altop:5194/images/Balk.png"
				alt=""
		...
		<div
			class="verzender-nummer"
			style="padding: 10px 20px; font-size: 1em; box-sizing: border-box;"
		>
			(telefoonnummer verzender)
		</div>

		<div
			class="informatie-container"
		...
		>
			...
			>
				<img
					class="base-img"
					data-src="https://docker07.ap.altop:5194/images/AdresVlak.png"
					alt=""
			...
			<div
				class="informatie-block"
				style="font-size: 1em; position: relative; z-index: 2; color: white;"
			>
				Stirlingstraat 4<br />
